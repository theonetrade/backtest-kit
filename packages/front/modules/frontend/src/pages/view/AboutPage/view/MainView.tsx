...
import { KeyboardArrowLeft, Telegram, GitHub, PictureAsPdfOutlined, Refresh, PictureAsPdf, Description, DataObject, Settings } from "@mui/icons-material";
import ioc from "../../../../lib";
...
export const MainView = () => {
  ...
  const handleAction = async (action: string) => {
    ...
    if (action === "setup-action") {
      ioc.routerService.push("/about/setup");
    }
