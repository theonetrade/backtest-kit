...
const fields: TypedField<IHeatmapRow>[] = [
    ...
    },
    {
        ...
        name: "sortinoRatio",
        title: "Sortino Ratio",
        compute: (obj) => (obj.sortinoRatio !== null ? obj.sortinoRatio.toFixed(3) : "N/A"),
        readonly: true,
    },
    {
        type: FieldType.Text,
        ...
        name: "calmarRatio",
        title: "Calmar Ratio",
        compute: (obj) => (obj.calmarRatio !== null ? obj.calmarRatio.toFixed(3) : "N/A"),
        readonly: true,
    },
    {
        type: FieldType.Text,
        ...
        compute: (obj) => (obj.recoveryFactor !== null ? obj.recoveryFactor.toFixed(3) : "N/A"),
        readonly: true,
    },
    {
        type: FieldType.Text,
