...
```ts
getTotalPercentHeld: (symbol: string, context: { strategyName: string; exchangeName: string; }) => Promise<number>
```
...
```ts
getRemainingCostBasis: (symbol: string, context: { strategyName: string; exchangeName: string; }) => Promise<number>
```
...
```ts
getStrategyStatus: (symbol: string, context: { strategyName: string; exchangeName: string; }) => Promise<StrategyStatus>
```
...
```ts
getPaused: (symbol: string, context: { strategyName: string; exchangeName: string; }) => Promise<boolean>
```
...
```ts
setPaused: (symbol: string, paused: boolean, context: { strategyName: string; exchangeName: string; }) => Promise<void>
```
...
```ts
list: () => Promise<{ id: string; symbol: string; strategyName: string; exchangeName: string; status: "rejected" | "pending" | "fulfilled" | "ready"; }[]>
```
