...
### __@WAIT_FOR_INIT_SYMBOL@4515

```ts
__@WAIT_FOR_INIT_SYMBOL@4515: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4516

```ts
__@WRITE_SAFE_SYMBOL@4516: IWrappedQueuedFn<symbol | void, [line: string]>
```
