...
### __@WAIT_FOR_INIT_SYMBOL@4232

```ts
__@WAIT_FOR_INIT_SYMBOL@4232: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4233

```ts
__@WRITE_SAFE_SYMBOL@4233: IWrappedQueuedFn<symbol | void, [line: string]>
```
