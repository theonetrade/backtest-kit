...
### __@WAIT_FOR_INIT_SYMBOL@4183

```ts
__@WAIT_FOR_INIT_SYMBOL@4183: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4184

```ts
__@WRITE_SAFE_SYMBOL@4184: IWrappedQueuedFn<symbol | void, [line: string]>
```
