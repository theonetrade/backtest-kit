...
### __@WAIT_FOR_INIT_SYMBOL@4455

```ts
__@WAIT_FOR_INIT_SYMBOL@4455: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@4456

```ts
__@WRITE_SAFE_SYMBOL@4456: IWrappedQueuedFn<symbol | void, [line: string]>
```
