...
const ERROR_MESSAGE_DEFAULT = "OrderTransientError";
 ...
 * ```
 */
export class OrderTransientError extends Error {
  /** Runtime brand (Symbol.for — survives duplicated module instances) */
  public readonly __type__ = ORDER_TRANSIENT_ERROR_TYPE;
  ...
  static fromError(error: object): OrderTransientError {
    return new OrderTransientError(getErrorMessage(error) || ERROR_MESSAGE_DEFAULT);
  }
}

export default OrderTransientError;
