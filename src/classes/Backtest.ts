...
const BACKTEST_METHOD_NAME_GET_TOTAL_PERCENT_HELD =
  "BacktestUtils.getTotalPercentHeld";
const BACKTEST_METHOD_NAME_GET_REMAINING_COST_BASIS =
  "BacktestUtils.getRemainingCostBasis";
...
const BACKTEST_METHOD_NAME_GET_PAUSED = "Backtest.getPaused";
const BACKTEST_METHOD_NAME_SET_PAUSED = "Backtest.setPaused";
...
export class BacktestUtils {
  ...
  public getTotalPercentHeld = async (
    ...
    backtest.loggerService.info(BACKTEST_METHOD_NAME_GET_TOTAL_PERCENT_HELD, {
      symbol,
      context,
    });
    backtest.strategyValidationService.validate(
      context.strategyName,
      BACKTEST_METHOD_NAME_GET_TOTAL_PERCENT_HELD,
    );
    backtest.exchangeValidationService.validate(
      context.exchangeName,
      BACKTEST_METHOD_NAME_GET_TOTAL_PERCENT_HELD,
  ...
  public getRemainingCostBasis = async (
    ...
    backtest.loggerService.info(BACKTEST_METHOD_NAME_GET_REMAINING_COST_BASIS, {
      symbol,
      context,
    });
    backtest.strategyValidationService.validate(
      context.strategyName,
      BACKTEST_METHOD_NAME_GET_REMAINING_COST_BASIS,
    );
    backtest.exchangeValidationService.validate(
      context.exchangeName,
      BACKTEST_METHOD_NAME_GET_REMAINING_COST_BASIS,
  ...
  public getPaused = async (
    ...
    backtest.loggerService.info(BACKTEST_METHOD_NAME_GET_PAUSED, {
      symbol,
      context,
    });
    backtest.strategyValidationService.validate(
      context.strategyName,
      BACKTEST_METHOD_NAME_GET_PAUSED,
    );
    backtest.exchangeValidationService.validate(
      context.exchangeName,
      BACKTEST_METHOD_NAME_GET_PAUSED,
   ...
   * await Backtest.setPaused("BTCUSDT", true, {
   *   strategyName: "my-strategy",
   *   exchangeName: "binance",
   *   frameName: "frame1",
   * });
  ...
  public setPaused = async (
    ...
    backtest.loggerService.info(BACKTEST_METHOD_NAME_SET_PAUSED, {
      symbol,
      paused,
      context,
    });
    backtest.strategyValidationService.validate(
      context.strategyName,
      BACKTEST_METHOD_NAME_SET_PAUSED,
    );
    backtest.exchangeValidationService.validate(
      context.exchangeName,
      BACKTEST_METHOD_NAME_SET_PAUSED,
